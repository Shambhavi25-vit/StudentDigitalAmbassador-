...
## 🚀 Project Overview
This repository serves as a curated collection of work completed during the Digital Literacy initiative. The goal is to showcase a transition from a digital consumer to a digitally literate professional, capable of navigating the modern academic and corporate landscape.

## 📂 Module Summaries

### 📍 Module 1: Digital Literacy Awareness
* **Objective:** Define and visualize the pillars of digital literacy for the student community.
* **Deliverable:** `[Infographic]` Highlighting safe internet practices and professional online presence.
* **Stack:** Canva, Graphic Design Principles.
...
* **Quiz Link:** [link](https://docs.google.com/forms/d/e/1FAIpQLSdHA3yRE2btXlxBrOOx1F07QInKN529zHOP9NQxWq2bkD9nZw/viewform?usp=publish-editor)
* **Responses Link:** [link](https://docs.google.com/spreadsheets/d/10462eluWstV6hqcyN1CvQoMMYnFahFOmJD0-AfDAVn4/edit?usp=sharing)
